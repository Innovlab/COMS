...
public class ShipmentActivity {
    ...
    protected ShipmentLocation activityLocation;
     ...
     * @return
     *     possible object is
     *     {@link ShipmentLocation }
     *     
     */
    public ShipmentLocation getActivityLocation() {
     ...
     *     
     */
    public void setActivityLocation(ShipmentLocation value) {
	...
	public String toString() {
		return "ShipmentActivity [activityLocation=" + activityLocation + ", description=" + description + ", date="
				+ date + ", time=" + time + ", trailer=" + trailer + "]";
	}

...
public class CustomDocumentDetail  implements java.io.Serializable {
    ...
    /* Applicable only to documents produced on thermal printers with
     * roll stock. */
    private com.cts.ptms.model.fedex.ws.ship.v17.LabelRotationType labelRotation;
    ...
    public CustomDocumentDetail(
           ...
           com.cts.ptms.model.fedex.ws.ship.v17.LabelRotationType labelRotation,
     ...
     * roll stock.
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.LabelRotationType getLabelRotation() {
     ...
     * roll stock.
     */
    public void setLabelRotation(com.cts.ptms.model.fedex.ws.ship.v17.LabelRotationType labelRotation) {
        this.labelRotation = labelRotation;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "CustomDocumentDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "LabelRotation"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "LabelRotationType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("specificationId");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "SpecificationId"));

...
public class NaftaProducer  implements java.io.Serializable {
    ...
    private com.cts.ptms.model.fedex.ws.ship.v17.Party producer;
    ...
    public NaftaProducer(
           java.lang.String id,
           com.cts.ptms.model.fedex.ws.ship.v17.Party producer) {
           this.id = id;
     ...
     * @return producer
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.Party getProducer() {
        return producer;
    }
     ...
     * @param producer
     */
    public void setProducer(com.cts.ptms.model.fedex.ws.ship.v17.Party producer) {
        this.producer = producer;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "NaftaProducer"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "Producer"));

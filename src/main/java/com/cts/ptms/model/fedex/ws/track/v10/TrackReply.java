...
public class TrackReply  implements java.io.Serializable {
    ...
    private com.cts.ptms.model.fedex.ws.track.v10.CompletedTrackDetail[] completedTrackDetails;
    ...
    public TrackReply(
           ...
           com.cts.ptms.model.fedex.ws.track.v10.CompletedTrackDetail[] completedTrackDetails) {
     ...
     */
    public com.cts.ptms.model.fedex.ws.track.v10.CompletedTrackDetail[] getCompletedTrackDetails() {
     ...
     */
    public void setCompletedTrackDetails(com.cts.ptms.model.fedex.ws.track.v10.CompletedTrackDetail[] completedTrackDetails) {
        this.completedTrackDetails = completedTrackDetails;
    }

    public com.cts.ptms.model.fedex.ws.track.v10.CompletedTrackDetail getCompletedTrackDetails(int i) {
        return this.completedTrackDetails[i];
    }

    public void setCompletedTrackDetails(int i, com.cts.ptms.model.fedex.ws.track.v10.CompletedTrackDetail _value) {

...
public class NaftaCommodityDetail  implements java.io.Serializable {
    ...
    private com.cts.ptms.model.fedex.ws.track.v10.NaftaPreferenceCriterionCode preferenceCriterion;

    /* Defined by NAFTA regulations. */
    private com.cts.ptms.model.fedex.ws.track.v10.NaftaProducerDeterminationCode producerDetermination;
    ...
    private com.cts.ptms.model.fedex.ws.track.v10.NaftaNetCostMethodCode netCostMethod;

    /* Date range over which RVC net cost was calculated. */
    private com.cts.ptms.model.fedex.ws.track.v10.DateRange netCostDateRange;

    public NaftaCommodityDetail() {
    }

    public NaftaCommodityDetail(
           com.cts.ptms.model.fedex.ws.track.v10.NaftaPreferenceCriterionCode preferenceCriterion,
           com.cts.ptms.model.fedex.ws.track.v10.NaftaProducerDeterminationCode producerDetermination,
           java.lang.String producerId,
           com.cts.ptms.model.fedex.ws.track.v10.NaftaNetCostMethodCode netCostMethod,
           com.cts.ptms.model.fedex.ws.track.v10.DateRange netCostDateRange) {
     ...
     */
    public com.cts.ptms.model.fedex.ws.track.v10.NaftaPreferenceCriterionCode getPreferenceCriterion() {
     ...
     */
    public void setPreferenceCriterion(com.cts.ptms.model.fedex.ws.track.v10.NaftaPreferenceCriterionCode preferenceCriterion) {
        this.preferenceCriterion = preferenceCriterion;
    }
     ...
     */
    public com.cts.ptms.model.fedex.ws.track.v10.NaftaProducerDeterminationCode getProducerDetermination() {
     ...
     */
    public void setProducerDetermination(com.cts.ptms.model.fedex.ws.track.v10.NaftaProducerDeterminationCode producerDetermination) {
        this.producerDetermination = producerDetermination;
    }
     ...
     */
    public com.cts.ptms.model.fedex.ws.track.v10.NaftaNetCostMethodCode getNetCostMethod() {
        return netCostMethod;
    }
     ...
     * @param netCostMethod
     */
    public void setNetCostMethod(com.cts.ptms.model.fedex.ws.track.v10.NaftaNetCostMethodCode netCostMethod) {
        this.netCostMethod = netCostMethod;
    }
     ...
     */
    public com.cts.ptms.model.fedex.ws.track.v10.DateRange getNetCostDateRange() {
     ...
     */
    public void setNetCostDateRange(com.cts.ptms.model.fedex.ws.track.v10.DateRange netCostDateRange) {
        this.netCostDateRange = netCostDateRange;
    }

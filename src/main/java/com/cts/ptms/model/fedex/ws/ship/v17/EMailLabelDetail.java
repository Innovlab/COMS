...
public class EMailLabelDetail  implements java.io.Serializable {
    ...
    private com.cts.ptms.model.fedex.ws.ship.v17.EMailRecipient[] recipients;
    ...
    public EMailLabelDetail(
           ...
           com.cts.ptms.model.fedex.ws.ship.v17.EMailRecipient[] recipients) {
     ...
     * @return recipients
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.EMailRecipient[] getRecipients() {
        return recipients;
    }
     ...
     * @param recipients
     */
    public void setRecipients(com.cts.ptms.model.fedex.ws.ship.v17.EMailRecipient[] recipients) {
        this.recipients = recipients;
    }

    public com.cts.ptms.model.fedex.ws.ship.v17.EMailRecipient getRecipients(int i) {
        return this.recipients[i];
    }

    public void setRecipients(int i, com.cts.ptms.model.fedex.ws.ship.v17.EMailRecipient _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "EMailLabelDetail"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "EMailRecipient"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);

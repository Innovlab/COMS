...
public class FreightRateDetail  implements java.io.Serializable {
    ...
    private com.cts.ptms.model.fedex.ws.ship.v17.FreightRateQuoteType quoteType;

    /* Specifies how total base charge is determined. */
    private com.cts.ptms.model.fedex.ws.ship.v17.FreightBaseChargeCalculationType baseChargeCalculation;

    /* Freight charges which accumulate to the total base charge for
     * the shipment. */
    private com.cts.ptms.model.fedex.ws.ship.v17.FreightBaseCharge[] baseCharges;

    /* Human-readable descriptions of additional information on this
     * shipment rating. */
    private com.cts.ptms.model.fedex.ws.ship.v17.FreightRateNotation[] notations;
    ...
    public FreightRateDetail(
           ...
           com.cts.ptms.model.fedex.ws.ship.v17.FreightRateQuoteType quoteType,
           com.cts.ptms.model.fedex.ws.ship.v17.FreightBaseChargeCalculationType baseChargeCalculation,
           com.cts.ptms.model.fedex.ws.ship.v17.FreightBaseCharge[] baseCharges,
           com.cts.ptms.model.fedex.ws.ship.v17.FreightRateNotation[] notations) {
     ...
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.FreightRateQuoteType getQuoteType() {
        return quoteType;
    }
     ...
     */
    public void setQuoteType(com.cts.ptms.model.fedex.ws.ship.v17.FreightRateQuoteType quoteType) {
        this.quoteType = quoteType;
    }
     ...
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.FreightBaseChargeCalculationType getBaseChargeCalculation() {
     ...
     */
    public void setBaseChargeCalculation(com.cts.ptms.model.fedex.ws.ship.v17.FreightBaseChargeCalculationType baseChargeCalculation) {
        this.baseChargeCalculation = baseChargeCalculation;
    }
     ...
     * the shipment.
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.FreightBaseCharge[] getBaseCharges() {
        return baseCharges;
    }
     ...
     * the shipment.
     */
    public void setBaseCharges(com.cts.ptms.model.fedex.ws.ship.v17.FreightBaseCharge[] baseCharges) {
        this.baseCharges = baseCharges;
    }

    public com.cts.ptms.model.fedex.ws.ship.v17.FreightBaseCharge getBaseCharges(int i) {
        return this.baseCharges[i];
    }

    public void setBaseCharges(int i, com.cts.ptms.model.fedex.ws.ship.v17.FreightBaseCharge _value) {
     ...
     * shipment rating.
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.FreightRateNotation[] getNotations() {
        return notations;
    }
     ...
     * shipment rating.
     */
    public void setNotations(com.cts.ptms.model.fedex.ws.ship.v17.FreightRateNotation[] notations) {
        this.notations = notations;
    }

    public com.cts.ptms.model.fedex.ws.ship.v17.FreightRateNotation getNotations(int i) {
        return this.notations[i];
    }

    public void setNotations(int i, com.cts.ptms.model.fedex.ws.ship.v17.FreightRateNotation _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "FreightRateDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("quoteNumber");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "QuoteNumber"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "QuoteType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "FreightRateQuoteType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("baseChargeCalculation");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "BaseChargeCalculation"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "FreightBaseChargeCalculationType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("baseCharges");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "BaseCharges"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "FreightBaseCharge"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "Notations"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "FreightRateNotation"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);

...
public class SendNotificationsReply  implements java.io.Serializable {
    ...
    private com.cts.ptms.model.fedex.ws.track.v10.TrackNotificationPackage[] packages;
    ...
    public SendNotificationsReply(
           ...
           com.cts.ptms.model.fedex.ws.track.v10.TrackNotificationPackage[] packages) {
     ...
     * to use on a subsequent request.
     */
    public com.cts.ptms.model.fedex.ws.track.v10.TrackNotificationPackage[] getPackages() {
        return packages;
    }
     ...
     * to use on a subsequent request.
     */
    public void setPackages(com.cts.ptms.model.fedex.ws.track.v10.TrackNotificationPackage[] packages) {
        this.packages = packages;
    }

    public com.cts.ptms.model.fedex.ws.track.v10.TrackNotificationPackage getPackages(int i) {
        return this.packages[i];
    }

    public void setPackages(int i, com.cts.ptms.model.fedex.ws.track.v10.TrackNotificationPackage _value) {

...
public class ShippingDocumentFormat  implements java.io.Serializable {
    ...
    private com.cts.ptms.model.fedex.ws.ship.v17.LinearMeasure topOfPageOffset;

    private com.cts.ptms.model.fedex.ws.ship.v17.ShippingDocumentImageType imageType;

    private com.cts.ptms.model.fedex.ws.ship.v17.ShippingDocumentStockType stockType;
    ...
    private com.cts.ptms.model.fedex.ws.ship.v17.DocumentFormatOptionType[] optionsRequested;
    ...
    public ShippingDocumentFormat(
           ...
           com.cts.ptms.model.fedex.ws.ship.v17.LinearMeasure topOfPageOffset,
           com.cts.ptms.model.fedex.ws.ship.v17.ShippingDocumentImageType imageType,
           com.cts.ptms.model.fedex.ws.ship.v17.ShippingDocumentStockType stockType,
           java.lang.Boolean provideInstructions,
           com.cts.ptms.model.fedex.ws.ship.v17.DocumentFormatOptionType[] optionsRequested,
     ...
     * image; allows for printing on letterhead and other pre-printed stock.
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.LinearMeasure getTopOfPageOffset() {
     ...
     * image; allows for printing on letterhead and other pre-printed stock.
     */
    public void setTopOfPageOffset(com.cts.ptms.model.fedex.ws.ship.v17.LinearMeasure topOfPageOffset) {
        this.topOfPageOffset = topOfPageOffset;
    }
     ...
     * @return stockType
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.ShippingDocumentStockType getStockType() {
        return stockType;
    }
     ...
     * @param stockType
     */
    public void setStockType(com.cts.ptms.model.fedex.ws.ship.v17.ShippingDocumentStockType stockType) {
        this.stockType = stockType;
    }
     ...
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.DocumentFormatOptionType[] getOptionsRequested() {
        return optionsRequested;
    }
     ...
     */
    public void setOptionsRequested(com.cts.ptms.model.fedex.ws.ship.v17.DocumentFormatOptionType[] optionsRequested) {
        this.optionsRequested = optionsRequested;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "ShippingDocumentFormat"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "TopOfPageOffset"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "LinearMeasure"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "StockType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "ShippingDocumentStockType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("provideInstructions");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "ProvideInstructions"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "OptionsRequested"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "DocumentFormatOptionType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "CustomDocumentIdentifier"));

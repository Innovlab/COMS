...
public class ShipServiceLocator extends org.apache.axis.client.Service implements com.cts.ptms.model.fedex.ws.ship.v17.ShipService {
    ...
    public com.cts.ptms.model.fedex.ws.ship.v17.ShipPortType getShipServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.cts.ptms.model.fedex.ws.ship.v17.ShipPortType getShipServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.cts.ptms.model.fedex.ws.ship.v17.ShipServiceSoapBindingStub _stub = new com.cts.ptms.model.fedex.ws.ship.v17.ShipServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.cts.ptms.model.fedex.ws.ship.v17.ShipPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.cts.ptms.model.fedex.ws.ship.v17.ShipServiceSoapBindingStub _stub = new com.cts.ptms.model.fedex.ws.ship.v17.ShipServiceSoapBindingStub(new java.net.URL(ShipServicePort_address), this);
                _stub.setPortName(getShipServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "ShipService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "ShipServicePort"));
        }

...
public class RequestedPackageLineItem  implements java.io.Serializable {
    ...
    private com.cts.ptms.model.fedex.ws.ship.v17.Money insuredValue;
    ...
    private com.cts.ptms.model.fedex.ws.ship.v17.Weight weight;

    private com.cts.ptms.model.fedex.ws.ship.v17.Dimensions dimensions;
    ...
    private com.cts.ptms.model.fedex.ws.ship.v17.PhysicalPackagingType physicalPackaging;
    ...
    private com.cts.ptms.model.fedex.ws.ship.v17.CustomerReference[] customerReferences;

    private com.cts.ptms.model.fedex.ws.ship.v17.PackageSpecialServicesRequested specialServicesRequested;

    /* Only used for INDIVIDUAL_PACKAGES and PACKAGE_GROUPS. */
    private com.cts.ptms.model.fedex.ws.ship.v17.ContentRecord[] contentRecords;
    ...
    public RequestedPackageLineItem(
           ...
           com.cts.ptms.model.fedex.ws.ship.v17.Money insuredValue,
           com.cts.ptms.model.fedex.ws.ship.v17.Weight weight,
           com.cts.ptms.model.fedex.ws.ship.v17.Dimensions dimensions,
           com.cts.ptms.model.fedex.ws.ship.v17.PhysicalPackagingType physicalPackaging,
           java.lang.String itemDescription,
           java.lang.String itemDescriptionForClearance,
           com.cts.ptms.model.fedex.ws.ship.v17.CustomerReference[] customerReferences,
           com.cts.ptms.model.fedex.ws.ship.v17.PackageSpecialServicesRequested specialServicesRequested,
           com.cts.ptms.model.fedex.ws.ship.v17.ContentRecord[] contentRecords) {
     ...
     * and packageCount on the shipment will be used to determine this value.
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.Money getInsuredValue() {
        return insuredValue;
    }
     ...
     * and packageCount on the shipment will be used to determine this value.
     */
    public void setInsuredValue(com.cts.ptms.model.fedex.ws.ship.v17.Money insuredValue) {
        this.insuredValue = insuredValue;
    }
     ...
     * the shipment will be used to determine this value.
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.Weight getWeight() {
        return weight;
    }
     ...
     * the shipment will be used to determine this value.
     */
    public void setWeight(com.cts.ptms.model.fedex.ws.ship.v17.Weight weight) {
        this.weight = weight;
    }
     ...
     * @return dimensions
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.Dimensions getDimensions() {
        return dimensions;
    }
     ...
     * @param dimensions
     */
    public void setDimensions(com.cts.ptms.model.fedex.ws.ship.v17.Dimensions dimensions) {
        this.dimensions = dimensions;
    }
     ...
     * under international and SmartPost services.
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.PhysicalPackagingType getPhysicalPackaging() {
     ...
     * under international and SmartPost services.
     */
    public void setPhysicalPackaging(com.cts.ptms.model.fedex.ws.ship.v17.PhysicalPackagingType physicalPackaging) {
        this.physicalPackaging = physicalPackaging;
    }
     ...
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.CustomerReference[] getCustomerReferences() {
        return customerReferences;
    }
     ...
     */
    public void setCustomerReferences(com.cts.ptms.model.fedex.ws.ship.v17.CustomerReference[] customerReferences) {
        this.customerReferences = customerReferences;
    }

    public com.cts.ptms.model.fedex.ws.ship.v17.CustomerReference getCustomerReferences(int i) {
        return this.customerReferences[i];
    }

    public void setCustomerReferences(int i, com.cts.ptms.model.fedex.ws.ship.v17.CustomerReference _value) {
     ...
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.PackageSpecialServicesRequested getSpecialServicesRequested() {
        return specialServicesRequested;
    }
     ...
     */
    public void setSpecialServicesRequested(com.cts.ptms.model.fedex.ws.ship.v17.PackageSpecialServicesRequested specialServicesRequested) {
        this.specialServicesRequested = specialServicesRequested;
    }
     ...
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.ContentRecord[] getContentRecords() {
     ...
     */
    public void setContentRecords(com.cts.ptms.model.fedex.ws.ship.v17.ContentRecord[] contentRecords) {
        this.contentRecords = contentRecords;
    }

    public com.cts.ptms.model.fedex.ws.ship.v17.ContentRecord getContentRecords(int i) {
        return this.contentRecords[i];
    }

    public void setContentRecords(int i, com.cts.ptms.model.fedex.ws.ship.v17.ContentRecord _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "RequestedPackageLineItem"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "GroupPackageCount"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "nonNegativeInteger"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "InsuredValue"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "Weight"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "Dimensions"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "PhysicalPackaging"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "PhysicalPackagingType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("itemDescription");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "ItemDescription"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "ItemDescriptionForClearance"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "CustomerReferences"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "CustomerReference"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "PackageSpecialServicesRequested"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("contentRecords");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "ContentRecords"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "ContentRecord"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);

...
public class PackageBarcodes  implements java.io.Serializable {
    ...
    private com.cts.ptms.model.fedex.ws.ship.v17.BinaryBarcode[] binaryBarcodes;

    /* String-style barcodes for this package. */
    private com.cts.ptms.model.fedex.ws.ship.v17.StringBarcode[] stringBarcodes;

    public PackageBarcodes() {
    }

    public PackageBarcodes(
           com.cts.ptms.model.fedex.ws.ship.v17.BinaryBarcode[] binaryBarcodes,
           com.cts.ptms.model.fedex.ws.ship.v17.StringBarcode[] stringBarcodes) {
     ...
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.BinaryBarcode[] getBinaryBarcodes() {
     ...
     */
    public void setBinaryBarcodes(com.cts.ptms.model.fedex.ws.ship.v17.BinaryBarcode[] binaryBarcodes) {
        this.binaryBarcodes = binaryBarcodes;
    }

    public com.cts.ptms.model.fedex.ws.ship.v17.BinaryBarcode getBinaryBarcodes(int i) {
        return this.binaryBarcodes[i];
    }

    public void setBinaryBarcodes(int i, com.cts.ptms.model.fedex.ws.ship.v17.BinaryBarcode _value) {
     ...
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.StringBarcode[] getStringBarcodes() {
     ...
     */
    public void setStringBarcodes(com.cts.ptms.model.fedex.ws.ship.v17.StringBarcode[] stringBarcodes) {
        this.stringBarcodes = stringBarcodes;
    }

    public com.cts.ptms.model.fedex.ws.ship.v17.StringBarcode getStringBarcodes(int i) {
        return this.stringBarcodes[i];
    }

    public void setStringBarcodes(int i, com.cts.ptms.model.fedex.ws.ship.v17.StringBarcode _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "PackageBarcodes"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("binaryBarcodes");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "BinaryBarcodes"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "BinaryBarcode"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "StringBarcodes"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "StringBarcode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);

...
public class EMailRecipient  implements java.io.Serializable {
    ...
    private com.cts.ptms.model.fedex.ws.ship.v17.AccessorRoleType role;

    /* Specifies how the email notification for the pending shipment
     * need to be processed. */
    private com.cts.ptms.model.fedex.ws.ship.v17.EmailOptionType[] optionsRequested;
    ...
    public EMailRecipient(
           ...
           com.cts.ptms.model.fedex.ws.ship.v17.AccessorRoleType role,
           com.cts.ptms.model.fedex.ws.ship.v17.EmailOptionType[] optionsRequested,
     ...
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.AccessorRoleType getRole() {
        return role;
    }
     ...
     */
    public void setRole(com.cts.ptms.model.fedex.ws.ship.v17.AccessorRoleType role) {
        this.role = role;
    }
     ...
     * need to be processed.
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.EmailOptionType[] getOptionsRequested() {
     ...
     * need to be processed.
     */
    public void setOptionsRequested(com.cts.ptms.model.fedex.ws.ship.v17.EmailOptionType[] optionsRequested) {
        this.optionsRequested = optionsRequested;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "EMailRecipient"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "AccessorRoleType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "EmailOptionType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);

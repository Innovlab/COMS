...
public class RadionuclideDetail  implements java.io.Serializable {
    ...
    private com.cts.ptms.model.fedex.ws.ship.v17.RadionuclideActivity activity;
    ...
    private com.cts.ptms.model.fedex.ws.ship.v17.PhysicalFormType physicalForm;
    ...
    public RadionuclideDetail(
           ...
           com.cts.ptms.model.fedex.ws.ship.v17.RadionuclideActivity activity,
           java.lang.Boolean exceptedPackagingIsReportableQuantity,
           com.cts.ptms.model.fedex.ws.ship.v17.PhysicalFormType physicalForm,
     ...
     * @return activity
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.RadionuclideActivity getActivity() {
        return activity;
    }
     ...
     * @param activity
     */
    public void setActivity(com.cts.ptms.model.fedex.ws.ship.v17.RadionuclideActivity activity) {
        this.activity = activity;
    }
     ...
     * @return physicalForm
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.PhysicalFormType getPhysicalForm() {
        return physicalForm;
    }
     ...
     * @param physicalForm
     */
    public void setPhysicalForm(com.cts.ptms.model.fedex.ws.ship.v17.PhysicalFormType physicalForm) {
        this.physicalForm = physicalForm;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "RadionuclideDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("radionuclide");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "Radionuclide"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "Activity"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "RadionuclideActivity"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("exceptedPackagingIsReportableQuantity");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "ExceptedPackagingIsReportableQuantity"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "PhysicalForm"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "PhysicalFormType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("chemicalForm");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "ChemicalForm"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);

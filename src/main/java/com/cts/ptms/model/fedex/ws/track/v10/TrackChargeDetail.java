...
public class TrackChargeDetail  implements java.io.Serializable {
    private com.cts.ptms.model.fedex.ws.track.v10.TrackChargeDetailType type;

    private com.cts.ptms.model.fedex.ws.track.v10.Money chargeAmount;

    public TrackChargeDetail() {
    }

    public TrackChargeDetail(
           com.cts.ptms.model.fedex.ws.track.v10.TrackChargeDetailType type,
           com.cts.ptms.model.fedex.ws.track.v10.Money chargeAmount) {
           this.type = type;
     ...
     * @return type
     */
    public com.cts.ptms.model.fedex.ws.track.v10.TrackChargeDetailType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(com.cts.ptms.model.fedex.ws.track.v10.TrackChargeDetailType type) {
        this.type = type;
    }
     ...
     * @return chargeAmount
     */
    public com.cts.ptms.model.fedex.ws.track.v10.Money getChargeAmount() {
        return chargeAmount;
    }
     ...
     * @param chargeAmount
     */
    public void setChargeAmount(com.cts.ptms.model.fedex.ws.track.v10.Money chargeAmount) {
        this.chargeAmount = chargeAmount;
    }

...
public class Op900Detail  implements java.io.Serializable {
     ...
     * OP-900. */
    private com.cts.ptms.model.fedex.ws.ship.v17.CustomerReferenceType reference;
    ...
    public Op900Detail(
           ...
           com.cts.ptms.model.fedex.ws.ship.v17.CustomerReferenceType reference,
     ...
     * OP-900.
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.CustomerReferenceType getReference() {
        return reference;
    }
     ...
     * OP-900.
     */
    public void setReference(com.cts.ptms.model.fedex.ws.ship.v17.CustomerReferenceType reference) {
        this.reference = reference;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "Op900Detail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "Reference"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "SignatureName"));

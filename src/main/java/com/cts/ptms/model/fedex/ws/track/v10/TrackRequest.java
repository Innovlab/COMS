...
public class TrackRequest  implements java.io.Serializable {
     ...
     * to be tracked. */
    private com.cts.ptms.model.fedex.ws.track.v10.TrackSelectionDetail[] selectionDetails;
    ...
    private com.cts.ptms.model.fedex.ws.track.v10.TrackRequestProcessingOptionType[] processingOptions;
    ...
    public TrackRequest(
           ...
           com.cts.ptms.model.fedex.ws.track.v10.TrackSelectionDetail[] selectionDetails,
           org.apache.axis.types.NonNegativeInteger transactionTimeOutValueInMilliseconds,
           com.cts.ptms.model.fedex.ws.track.v10.TrackRequestProcessingOptionType[] processingOptions) {
     ...
     * to be tracked.
     */
    public com.cts.ptms.model.fedex.ws.track.v10.TrackSelectionDetail[] getSelectionDetails() {
     ...
     * to be tracked.
     */
    public void setSelectionDetails(com.cts.ptms.model.fedex.ws.track.v10.TrackSelectionDetail[] selectionDetails) {
        this.selectionDetails = selectionDetails;
    }

    public com.cts.ptms.model.fedex.ws.track.v10.TrackSelectionDetail getSelectionDetails(int i) {
        return this.selectionDetails[i];
    }

    public void setSelectionDetails(int i, com.cts.ptms.model.fedex.ws.track.v10.TrackSelectionDetail _value) {
     ...
     */
    public com.cts.ptms.model.fedex.ws.track.v10.TrackRequestProcessingOptionType[] getProcessingOptions() {
        return processingOptions;
    }
     ...
     */
    public void setProcessingOptions(com.cts.ptms.model.fedex.ws.track.v10.TrackRequestProcessingOptionType[] processingOptions) {
        this.processingOptions = processingOptions;
    }

    public com.cts.ptms.model.fedex.ws.track.v10.TrackRequestProcessingOptionType getProcessingOptions(int i) {
        return this.processingOptions[i];
    }

    public void setProcessingOptions(int i, com.cts.ptms.model.fedex.ws.track.v10.TrackRequestProcessingOptionType _value) {

...
public class EdtCommodityTax  implements java.io.Serializable {
    ...
    private com.cts.ptms.model.fedex.ws.ship.v17.EdtTaxDetail[] taxes;
    ...
    public EdtCommodityTax(
           ...
           com.cts.ptms.model.fedex.ws.ship.v17.EdtTaxDetail[] taxes) {
     ...
     * @return taxes
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.EdtTaxDetail[] getTaxes() {
        return taxes;
    }
     ...
     * @param taxes
     */
    public void setTaxes(com.cts.ptms.model.fedex.ws.ship.v17.EdtTaxDetail[] taxes) {
        this.taxes = taxes;
    }

    public com.cts.ptms.model.fedex.ws.ship.v17.EdtTaxDetail getTaxes(int i) {
        return this.taxes[i];
    }

    public void setTaxes(int i, com.cts.ptms.model.fedex.ws.ship.v17.EdtTaxDetail _value) {
        this.taxes[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "EdtCommodityTax"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "EdtTaxDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);

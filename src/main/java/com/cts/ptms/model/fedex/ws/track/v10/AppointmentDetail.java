...
public class AppointmentDetail  implements java.io.Serializable {
    ...
    private com.cts.ptms.model.fedex.ws.track.v10.AppointmentTimeDetail[] windowDetails;
    ...
    public AppointmentDetail(
           java.util.Date date,
           com.cts.ptms.model.fedex.ws.track.v10.AppointmentTimeDetail[] windowDetails) {
           this.date = date;
     ...
     */
    public com.cts.ptms.model.fedex.ws.track.v10.AppointmentTimeDetail[] getWindowDetails() {
     ...
     */
    public void setWindowDetails(com.cts.ptms.model.fedex.ws.track.v10.AppointmentTimeDetail[] windowDetails) {
        this.windowDetails = windowDetails;
    }

    public com.cts.ptms.model.fedex.ws.track.v10.AppointmentTimeDetail getWindowDetails(int i) {
        return this.windowDetails[i];
    }

    public void setWindowDetails(int i, com.cts.ptms.model.fedex.ws.track.v10.AppointmentTimeDetail _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v10", "AppointmentDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("date");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v10", "Date"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/track/v10", "WindowDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/track/v10", "AppointmentTimeDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);

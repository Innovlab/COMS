...
public class ShipmentRating  implements java.io.Serializable {
    ...
    private com.cts.ptms.model.fedex.ws.ship.v17.ReturnedRateType actualRateType;

    /* The "list" total net charge minus "actual" total net charge. */
    private com.cts.ptms.model.fedex.ws.ship.v17.Money effectiveNetDiscount;

    /* Each element of this field provides shipment-level rate totals
     * for a specific rate type. */
    private com.cts.ptms.model.fedex.ws.ship.v17.ShipmentRateDetail[] shipmentRateDetails;

    public ShipmentRating() {
    }

    public ShipmentRating(
           com.cts.ptms.model.fedex.ws.ship.v17.ReturnedRateType actualRateType,
           com.cts.ptms.model.fedex.ws.ship.v17.Money effectiveNetDiscount,
           com.cts.ptms.model.fedex.ws.ship.v17.ShipmentRateDetail[] shipmentRateDetails) {
     ...
     * is considered as presenting the "actual" rates for the shipment.
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.ReturnedRateType getActualRateType() {
     ...
     * is considered as presenting the "actual" rates for the shipment.
     */
    public void setActualRateType(com.cts.ptms.model.fedex.ws.ship.v17.ReturnedRateType actualRateType) {
        this.actualRateType = actualRateType;
    }
     ...
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.Money getEffectiveNetDiscount() {
     ...
     */
    public void setEffectiveNetDiscount(com.cts.ptms.model.fedex.ws.ship.v17.Money effectiveNetDiscount) {
        this.effectiveNetDiscount = effectiveNetDiscount;
    }
     ...
     * for a specific rate type.
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.ShipmentRateDetail[] getShipmentRateDetails() {
     ...
     * for a specific rate type.
     */
    public void setShipmentRateDetails(com.cts.ptms.model.fedex.ws.ship.v17.ShipmentRateDetail[] shipmentRateDetails) {
        this.shipmentRateDetails = shipmentRateDetails;
    }

    public com.cts.ptms.model.fedex.ws.ship.v17.ShipmentRateDetail getShipmentRateDetails(int i) {
        return this.shipmentRateDetails[i];
    }

    public void setShipmentRateDetails(int i, com.cts.ptms.model.fedex.ws.ship.v17.ShipmentRateDetail _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "ShipmentRating"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("actualRateType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "ActualRateType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "EffectiveNetDiscount"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "ShipmentRateDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "ShipmentRateDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);

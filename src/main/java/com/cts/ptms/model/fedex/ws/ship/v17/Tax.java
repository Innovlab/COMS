...
public class Tax  implements java.io.Serializable {
    ...
    private com.cts.ptms.model.fedex.ws.ship.v17.TaxType taxType;
    ...
    public Tax(
           com.cts.ptms.model.fedex.ws.ship.v17.TaxType taxType,
     ...
     */
    public com.cts.ptms.model.fedex.ws.ship.v17.TaxType getTaxType() {
        return taxType;
    }
     ...
     */
    public void setTaxType(com.cts.ptms.model.fedex.ws.ship.v17.TaxType taxType) {
        this.taxType = taxType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "Tax"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v17", "TaxType"));

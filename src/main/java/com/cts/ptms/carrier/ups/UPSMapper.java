...
import com.cts.ptms.model.confirm.request.CodeType;
import com.cts.ptms.model.confirm.request.ContactsType;
import com.cts.ptms.model.confirm.request.DiscountType;
import com.cts.ptms.model.confirm.request.FreightChargesType;
import com.cts.ptms.model.confirm.request.InsuranceChargesType;
import com.cts.ptms.model.confirm.request.InternationalFormsType;
import com.cts.ptms.model.confirm.request.OtherChargesType;
import com.cts.ptms.model.confirm.request.PackageType;
import com.cts.ptms.model.confirm.request.PackageWeightType;
...
import com.cts.ptms.model.confirm.request.TransactionReferenceType;
import com.cts.ptms.model.confirm.request.UnitType;
import com.cts.ptms.model.gls.ADDRESS;
import com.cts.ptms.model.gls.CreateShipUnits;
import com.cts.ptms.model.gls.INVOICE;
import com.cts.ptms.model.gls.SHIPUNIT;
import com.cts.ptms.model.gls.ShipmentAcceptRequest;
import com.cts.ptms.model.gls.ShipmentAcceptRequestObjectFactory;
import com.cts.ptms.model.gls.ShipmentConfirmResponse;
...
public class UPSMapper {
	...
	public  ShipmentConfirmRequest populateShipConfirmRequest(CreateShipUnits createShipUnits,boolean isGenlabel) {
		...
		com.cts.ptms.model.confirm.request.ObjectFactory requestObjectFactory = new com.cts.ptms.model.confirm.request.ObjectFactory();
...
//						}
	...
	;
		...
		product.setNumberOfPackagesPerCommodity("1");
        ...
        internationalForms.setExportingCarrier("UPS International");
        
        shipRequest.getShipment().getShipmentServiceOptions().getInternationalForms().setContacts(contacts);
